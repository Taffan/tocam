...
- Gallery photo picker button for KE/SN (choose existing photo instead of scanning)
- Sound + vibration
...
- Usage guide: report creation, photography, scanner, gallery, completion, export
